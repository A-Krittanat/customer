package com.dagitalacademy.customer.service;
...
public class CustomerServiceTest {
    ...
    void tstGetAllCustomer() {
        ...
        assertEquals("iamgigue@test.com", resp.get(0).getEmail());
        assertEquals("0898887777", resp.get(0).getPhoneNo());
        ...
        assertEquals("0898887776", resp.get(1).getPhoneNo());
        assertEquals(25, resp.get(1).getAge().intValue());
    }
    ...
    void testGetAllCustomerById() {
        ...
        assertEquals("iamgigue@test.com", resp.getEmail());
        assertEquals("0898887777", resp.getPhoneNo());
    ...
    void testCreateCustomer() {
        ...
        reqCustomer.setPhoneNo("0898886666");
        ...
        assertEquals("0898886666", resp.getPhoneNo());
