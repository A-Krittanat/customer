package com.dagitalacademy.customer.api;
...
@SpringBootTest(classes = LoanServiceTest.class)
public class LoanServiceTest {
    ...
    public static ResponseEntity<String> prepareResponseSuccess() {
        return ResponseEntity.ok("{\n" +
                ...
                "        \"id\": 1,\n" +
                "        \"status\": \"OK\",\n" +
                "        \"account_payable\": \"102-220-2200\",\n" +
                "        \"account_receivable\": \"102-210-2020\",\n" +
                "        \"principal_amount\": 3200.0\n" +
                "    }\n" +
                "}");
    }

    @DisplayName("Test get loan info should return information")
    @Test
    void testGetLoanInfo() throws Exception {
        ...
        assertEquals("102-220-2200", resp.getAccountPayable());
        assertEquals("102-210-2020", resp.getAccountReceivable());
        assertEquals(3200.0, resp.getPrincipalAmount());
